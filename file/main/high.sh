...
sleep 4.0
echo -e "$cyan REMOVED METASPLOIT SUCCESSFULLY.....[\e[92m✓$cyan ]\e[0m"
sleep 4.0
else
echo
fi
...
echo -e "$cyan PACKAGES INSTALLED SUCCESSFULLY....[\e[92m✓$cyan ]\e[0m"
echo -e "\033[92m"
...
echo -e "$cyan METASPLOIT \e[92m$ver$cyan  INSTALLED SUCCESSFULLY....[\e[92m✓$cyan ]\e[92m"
center "COMPLETING ALL PROCESS"
cd $loc
echo -e "$cyan COMPLETING WAIT.....\e[0m"
rm $ver.tar.gz >/dev/null 2>&1
rm ruby.deb >/dev/null 2>&1
echo -e "$cyan COMPLETED SUCCESSFULLY....[\e[92m✓$cyan ]\e[92m"
